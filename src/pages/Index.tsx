...
import { Upload, Download, Image as ImageIcon, Check, X, Loader2, AlertTriangle, Github, Menu } from "lucide-react";
        ...
        {menuOpen && (
          <div className="mx-auto mt-2 max-w-6xl rounded-3xl border border-border/60 bg-background/95 p-3 shadow-elegant backdrop-blur-md md:hidden">
            <div className="flex flex-col">
              <a onClick={() => setMenuOpen(false)} href="#generator" className="rounded-2xl px-4 py-3 text-xs font-medium uppercase tracking-[0.14em] text-foreground/80 hover:bg-accent">
                {t("nav.generator")}
              </a>
              <a onClick={() => setMenuOpen(false)} href="#platforms" className="rounded-2xl px-4 py-3 text-xs font-medium uppercase tracking-[0.14em] text-foreground/80 hover:bg-accent">
                {t("nav.platforms")}
              </a>
