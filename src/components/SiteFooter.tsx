...
const SiteFooter = () => {
  ...
  return (
    <footer className="mt-auto border-t border-border bg-background pt-10 pb-12">
      <div className="container max-w-6xl">
        <div className="flex flex-col items-start justify-between gap-8 md:flex-row md:items-end">
          <div>
            <p className="font-display text-2xl font-semibold tracking-tight md:text-3xl">{t("footer.heading")}</p>
            <p className="mt-2 max-w-md text-sm text-foreground/60">{t("footer.body")}</p>
          </div>
